...
public class ExpenseCategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        categories = controller.getCategoriesExpenseSetting();

            rootView= inflater.inflate(R.layout.fragment_income_category,null);//fragmentlayoutnya sama aja designnya dngn income
            linearLayout = (LinearLayout) rootView.findViewById(R.id.r_layout_category);
            listView =(ListView) rootView.findViewById(R.id.lv_income_category);//fragmentlayoutnya sama aja designnya dngn incoem
            setValueCategory();
